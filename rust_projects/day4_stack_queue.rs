...
fn main() {
    ...
    tests::test_valid_parentheses();
    println!("✓ test_valid_parentheses passed");

    tests::test_min_stack();
    println!("✓ test_min_stack passed");

    tests::test_eval_rpn();
    println!("✓ test_eval_rpn passed");

    tests::test_next_greater_element();
    println!("✓ test_next_greater_element passed");

    tests::test_daily_temperatures();
    println!("✓ test_daily_temperatures passed");

    tests::test_largest_rectangle_in_histogram();
    println!("✓ test_largest_rectangle_in_histogram passed");

    tests::test_num_islands();
    println!("✓ test_num_islands passed");

    tests::test_rotting_oranges();
    println!("✓ test_rotting_oranges passed");

    tests::test_circular_queue();
    println!("✓ test_circular_queue passed");

    tests::test_shortest_path_binary_matrix();
    println!("✓ test_shortest_path_binary_matrix passed");
