"""
Script to create Day 2 Word document for DSA Study Plan.
Creates a comprehensive guide for Advanced Array Manipulation Techniques.
"""
...
def create_day2_document():
    ...
    # Section 7: Summary
    doc.add_heading('7. Summary & Next Steps', level=1)
    ...
    doc.add_paragraph(
        ...
        "Code every solution yourself, even if you understand the approach conceptually.",
        style='Quote'
    )
    
    # Save document
    doc.save('Day2_Advanced_Arrays.docx')
    print("Day 2 Word document created successfully: Day2_Advanced_Arrays.docx")


if __name__ == "__main__":
    create_day2_document()
